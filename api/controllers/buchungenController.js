...
exports.getAll = function (req, res) {
    connection.query(`SELECT * FROM Buchungen`, (err, rows) => {
...
exports.createNew = function (req, res) {
    connection.query('INSERT INTO Buchungen SET ?', req.body, (err, result) => {
...
exports.delete = function (req, res) {
	...
	connection.query('DELETE FROM Buchungen Where id = ?', [id], (err, result) => {	
